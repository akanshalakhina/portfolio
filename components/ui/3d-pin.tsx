    ...
    >
      ...
      >
        <div
          ...
          className="absolute left-1/2 top-1/2 flex items-start justify-start overflow-hidden rounded-2xl border border-black/[0.05] bg-white/[0.85] backdrop-blur-md p-4 shadow-[0_8px_32px_rgba(3,35,75,0.06)] transition duration-700 group-hover/pin:border-black/[0.1] dark:border-white/[0.1] dark:bg-[#0a0a1a]"
        >
      ...
      <div className="inset-0 -mt-7 h-full w-full flex-none">
        <div className="absolute inset-x-0 top-0 flex justify-center">
          <Link
            href={href || ""}
            target="_blank"
            className="relative z-10 flex items-center space-x-2 rounded-full bg-slate-900 px-4 py-0.5 ring-1 ring-white/10 dark:bg-slate-900"
          >
